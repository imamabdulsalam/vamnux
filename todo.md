...
- [ ] Validate Product Tracking authorization, supplier/data isolation, stock visibility recovery, manual and scheduled sync behavior, customer catalog visibility, focused tests, build, and visual checks; then checkpoint, push, and report.
