...
- [ ] Reduce VAMNUX production build peak memory for Namecheap shared cPanel/CloudLinux without changing dependencies, Node.js 22, Vite 7, application functionality, data, or production startup; validate clean npm install, check, build output, startup, checkpoint, and GitHub push.
