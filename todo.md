...
- [ ] Make normal cPanel npm installation reliably include Vite 7 and all VAMNUX build tooling by aligning the committed package manifest and npm lock/configuration; verify a clean production-mode npm install creates `node_modules/vite`, type-checks, builds, checkpoints, and pushes without changing application functionality or data.
