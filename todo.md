...
- [ ] Diagnose and resolve the cPanel Node 22 tsx/esbuild binary-version mismatch; validate one clean production-mode npm install, type-check, production build with `dist/index.js`, and startup readiness, then checkpoint and push without changing VAMNUX functionality or data.
