...
type ManualCatalogForm = {
  name: string;
  category: "gift_card" | "subscription" | "software" | "ai_tool" | "game_key" | "steam" | "telegram_stars";
  description: string;
