...
export default function DigitalProductDetail() {
  ...
  return <main className="game-family-page">
    ...
    <section className="family-detail-hero"><button className="family-back" onClick={() => setLocation("/")}><ArrowLeft size={17} /> All digital listings</button><div className="family-detail-hero-grid"><div className="family-detail-art"><DigitalIcon category={product.category} /><span>{product.category}</span></div><div className="family-detail-summary"><p className="detail-eyebrow">Digital product listing</p><h1>{product.product}</h1><p>{product.description}</p><div><ShieldCheck size={17} /> Product availability <CircleDollarSign size={17} /> USD base price</div></div></div></section>
