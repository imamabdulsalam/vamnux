...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setLoadedCatalogItems((current) => supplierCatalog.data.page === 1 ? supplierCatalog.data.items : [...current, ...supplierCatalog.data.items.filter((item) => !current.some((loaded) => loaded.id === item.id))]);
