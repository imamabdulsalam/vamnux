...
export default function UserDashboard() {
  ...
  const [topUpCurrency, setTopUpCurrency] = useState<"USD" | "EUR" | "GBP" | "NGN">("USD");
  ...
  useEffect(() => {
    ...
    setTopUpCurrency((dashboard.data.profile.preferredCurrency || "USD") as "USD" | "EUR" | "GBP" | "NGN");
  ...
  const submitTopUpRequest = (event: FormEvent<HTMLFormElement>) => {
    ...
    createWalletFundingRequest.mutate({ amount, currency: topUpCurrency, customerNote: topUpNote.trim() || undefined });
  };
