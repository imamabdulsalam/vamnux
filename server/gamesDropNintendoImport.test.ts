...
const runner = readFileSync("/home/ubuntu/gamesdrop_nintendo_import_2026-08-25.mjs", "utf8");

describe("GamesDrop Nintendo-only import safeguards", () => {
  it("locks supplier retrieval and normalized rows to Games plus exact Nintendo platform evidence", () => {
    ...
    expect(runner).toContain('const TARGET_PLATFORM = "nintendo"');
