...
const runner = readFileSync("/home/ubuntu/gamesdrop_mobile_import_2026-08-25.mjs", "utf8");

describe("GamesDrop Mobile-only import safeguards", () => {
  it("locks supplier retrieval and normalized rows to Games plus exact Nintendo platform evidence", () => {
    ...
    expect(runner).toContain('const TARGET_PLATFORM = "mobile"');
