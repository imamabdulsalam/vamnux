...
export const appRouter = router({
  ...
  admin: router({
    ...
    listAdminProductOperations: adminProcedure.input(z.object({ limit: z.number().int().min(1).max(100_000).default(100_000) }).optional()).query(({ input }) => listAdminProductOperations(input?.limit)),
