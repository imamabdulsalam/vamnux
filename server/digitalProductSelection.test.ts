...
describe("digital product selection layout", () => {
  it("keeps non-game supplier listings in the same selected-item format used for denomination families", async () => {
    ...
    expect(source).toContain("Saved selection only. Payment, wallet funding, supplier ordering, and delivery remain inactive.");
  });
});
