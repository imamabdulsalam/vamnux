...
const runner = readFileSync("/home/ubuntu/gamesdrop_eaapp_import_2026-08-25.mjs", "utf8");

describe("GamesDrop EA App-only import safeguards", () => {
  it("locks supplier retrieval and normalized rows to Games plus exact Nintendo platform evidence", () => {
    ...
    expect(runner).toContain('const TARGET_PLATFORM = "ea"');
